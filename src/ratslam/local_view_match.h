...
private:
  ...
  std::vector<double> current_view; // the template storing block value

  int image_size;
  int current_vt;
  double current_mean;// the mean value of all the blocks in the current view
  double vt_error; // the minimum comparison error between current view and the templates
  int prev_vt;
